...
export declare class GeoFirestoreQuery {
     ...
     */
    constructor(_collectionRef: firebase.firestore.CollectionReference, _queryCriteria: QueryCriteria);
    /********************/
    /********************/
    /**
     ...
     */
    private _fireCallbacksForKey(eventType, key, location?, distanceFromCenter?, document?);
    /**
     ...
     */
    private _updateLocation(key, location?, document?);
}
